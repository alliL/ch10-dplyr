...
team_data %>% filter(Ratio == min(Ratio)) %>% select(Team)
...
better_shooter <- better_shooters("Golden State Warriors*", "Cleveland Cavaliers*")
better_shooter
